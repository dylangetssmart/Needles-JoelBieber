...
begin
	alter table [sma_TRN_Disbursement] add [source_id_1] VARCHAR(MAX) null;
end
go
...
begin
	alter table [sma_TRN_Disbursement] add [source_id_2] VARCHAR(MAX) null;
end
go
...
begin
	alter table [sma_TRN_Disbursement] add [source_id_3] VARCHAR(MAX) null;
end
go
