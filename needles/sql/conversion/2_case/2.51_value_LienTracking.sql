...
/*
alter table [SAJohnSalazar_Needles].[dbo].[sma_TRN_Lienors] disable trigger all
delete from [SAJohnSalazar_Needles].[dbo].[sma_TRN_Lienors] 
DBCC CHECKIDENT ('[SAJohnSalazar_Needles].[dbo].[sma_TRN_Lienors]', RESEED, 0);
alter table [SAJohnSalazar_Needles].[dbo].[sma_TRN_Lienors] enable trigger all

alter table [SAJohnSalazar_Needles].[dbo].[sma_TRN_LienDetails] disable trigger all
delete from [SAJohnSalazar_Needles].[dbo].[sma_TRN_LienDetails] 
DBCC CHECKIDENT ('[SAJohnSalazar_Needles].[dbo].[sma_TRN_LienDetails]', RESEED, 0);
alter table [SAJohnSalazar_Needles].[dbo].[sma_TRN_LienDetails] enable trigger all
...
select count(*) from [SAJohnSalazar_Needles].[dbo].[sma_TRN_Lienors]
...
CREATE NONCLUSTERED INDEX IX_NonClustered_Index_value_tab_Liencheckbox_Helper_value_id ON [SAJohnSalazar_Needles].[dbo].[value_tab_Liencheckbox_Helper] (value_id);   
GO
...
---(0)---
insert into [SAJohnSalazar_Needles].[dbo].[sma_MST_LienType]
(
    [lntsCode]
    ,[lntsDscrptn]
)
...
select [lntsCode],[lntsDscrptn] from [SAJohnSalazar_Needles].[dbo].[sma_MST_LienType] 
GO
...
CREATE NONCLUSTERED INDEX IX_NonClustered_Index_value_tab_Lien_Helper_case_id ON [SAJohnSalazar_Needles].[dbo].[value_tab_Lien_Helper] (case_id);   
CREATE NONCLUSTERED INDEX IX_NonClustered_Index_value_tab_Lien_Helper_value_id ON [SAJohnSalazar_Needles].[dbo].[value_tab_Lien_Helper] (value_id);   
CREATE NONCLUSTERED INDEX IX_NonClustered_Index_value_tab_Lien_Helper_ProviderNameId ON [SAJohnSalazar_Needles].[dbo].[value_tab_Lien_Helper] (ProviderNameId);   
GO
...
inner join [SAJohnSalazar_Needles].[dbo].[sma_TRN_cases] CAS
    on CAS.cassCaseNumber = V.case_id
inner join [SAJohnSalazar_Needles].[dbo].[IndvOrgContacts_Indexed] IOC
...
select 
    V.case_id		    as cid,	
    V.value_id		    as vid,
    convert(varchar,((select sum(payment_amount) from [JohnSalazar_Needles].[dbo].[value_payment] where value_id=V.value_id))) as Paid,
    T.plnnPlaintiffID
    into value_tab_Multi_Party_Helper_Temp   
from [JohnSalazar_Needles].[dbo].[value_Indexed] V
inner join [SAJohnSalazar_Needles].[dbo].[sma_TRN_cases] CAS on CAS.cassCaseNumber = V.case_id
inner join [SAJohnSalazar_Needles].[dbo].[IndvOrgContacts_Indexed] IOC on IOC.SAGA = V.party_id
inner join [SAJohnSalazar_Needles].[dbo].[sma_TRN_Plaintiff] T on T.plnnContactID=IOC.CID and T.plnnContactCtg=IOC.CTG and T.plnnCaseID=CAS.casnCaseID
GO
...
select 
    ...
    V.value_id		    as vid,
    convert(varchar,((select sum(payment_amount) from [JohnSalazar_Needles].[dbo].[value_payment] where value_id=V.value_id))) as Paid,
    ( select plnnPlaintiffID from [SAJohnSalazar_Needles].[dbo].[sma_TRN_Plaintiff] where plnnCaseID=CAS.casnCaseID and plnbIsPrimary=1) as plnnPlaintiffID 
    into value_tab_Multi_Party_Helper_Temp   
from [JohnSalazar_Needles].[dbo].[value_Indexed] V
inner join [SAJohnSalazar_Needles].[dbo].[sma_TRN_cases] CAS on CAS.cassCaseNumber = V.case_id
inner join [SAJohnSalazar_Needles].[dbo].[IndvOrgContacts_Indexed] IOC on IOC.SAGA = V.party_id
inner join [SAJohnSalazar_Needles].[dbo].[sma_TRN_Defendants] D on D.defnContactID=IOC.CID and D.defnContactCtgID=IOC.CTG and D.defnCaseID=CAS.casnCaseID
GO
...
GO
---(1)---
insert into [SAJohnSalazar_Needles].[dbo].[sma_TRN_Lienors]
(
    [lnrnCaseID],
    [lnrnLienorTypeID],
  ...
  select 
    ...
    ( select top 1 lntnLienTypeID FROM [SAJohnSalazar_Needles].[dbo].[sma_MST_LienType] where lntsDscrptn=
	   (select [description] FROM [JohnSalazar_Needles].[dbo].[value_code] where [code]=V.code)) 
						  as [lnrnLienorTypeID],				   
    ...
    V.value_id				  as [saga]
from [JohnSalazar_Needles].[dbo].[value_Indexed] V
inner join [SAJohnSalazar_Needles].[dbo].[value_tab_Lien_Helper] MAP on MAP.case_id=V.case_id and MAP.value_id=V.value_id

---(2)---
insert into [SAJohnSalazar_Needles].[dbo].[sma_TRN_LienDetails]
(
	lndnLienorID,
	lndnLienTypeID,
...
from [SAJohnSalazar_Needles].[dbo].[sma_TRN_Lienors]
