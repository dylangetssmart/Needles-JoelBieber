...
FROM TestNeedles.[dbo].[insurance_Indexed] INS
...
SELECT 'Unspecified'
UNION
SELECT DISTINCT policy_type FROM TestNeedles.[dbo].[insurance] INS WHERE isnull(policy_type,'') <> '' 
EXCEPT
...
--FROM TestNeedles.[dbo].[insurance_Indexed] INS
--LEFT JOIN TestNeedles.[dbo].[user_insurance_data] UD on INS.insurance_id=UD.insurance_id
