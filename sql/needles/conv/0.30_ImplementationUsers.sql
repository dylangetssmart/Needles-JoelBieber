...
--CREATE TABLE implementation_users ( StaffCode varchar(50), SAloginID varchar(20),Prefix varchar(10), SAFirst varchar(50), SAMiddle varchar(5), SALast varchar(50), suffix varchar(15), Active varchar(1), visible varchar(1) )    
--GO
