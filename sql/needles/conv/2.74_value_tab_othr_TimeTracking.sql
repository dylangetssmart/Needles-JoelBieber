...
(
	...
	JOIN JoelBieberNeedles.[dbo].[value_code] VC on VC.code=V.code 
	WHERE isnull(V.code,'') in ('PBT') 
EXCEPT 
...
LEFT JOIN JoelBieberNeedles.[dbo].[party_Indexed] P on P.party_id=V.party_id and P.case_id=v.case_id
