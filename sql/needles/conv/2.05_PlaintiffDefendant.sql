...
SELECT DISTINCT 
    ...
    LEFT JOIN JoelBieberNeedles.[dbo].[party_indexed] P on P.TableIndex=T.saga_party
) A
WHERE A.RowNumber=1
...
FROM (
    ...
    LEFT JOIN JoelBieberNeedles.[dbo].[party_indexed] P on P.TableIndex=D.saga_party
) A
WHERE A.RowNumber=1
