...
######################################################################
*/
SELECT distinct type FROM ShinerLitify..Task t
...
insert into [sma_TRN_TaskNew]
	...
	where ISNULL(t.[Type], 'Other') <> 'Outbound Email';  -- ds 2024-09-05 Shiner custom - Exclude "Outbound Email"
